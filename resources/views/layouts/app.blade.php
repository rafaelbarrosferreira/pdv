...
<div class="flex flex-col  justify-start  min-h-screen py-12 bg-gray-100 sm:px-6 lg:px-8">
    <div class="absolute top-0 right-0 mt-4 mr-4">
        ...
        <div class="space-x-4 ">
            ...
            <a x-show="open" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="  font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">
                Sair
            </a>
            ...
            @else
            <a href="{{ route('login') }}" class="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">Log
                in</a>
    ...
    <x-card class="">
        <ul class="flex justify-between text-center text-lg">
            ...
            <li class="mr-6">
                <a class="@if(Route::currentRouteName() == 'venda.index')text-blue-500 hover:text-blue-800 @endif text-gray-500 focus:border-gray-800 hover:text-gray-800" href="{{route('venda.index')}}">Vendas</a>
            </li>
    ...
    <div class="mt-4">
        ...
        <div class="message message-error hidden">
            <p>Error ao realizar operação!</p>
        </div>
